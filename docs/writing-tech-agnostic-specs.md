...
This guide helps you understand how IaC Spec Kit approaches infrastructure specifications using generic terms rather than cloud-specific service names.

## How to Use This Guide

**Important:** You don't need to memorize or manually apply these guidelines. IaC Spec Kit is designed to guide AI assistants to follow these patterns when generating specifications through commands like `/iac.specify`. This guide helps you:

- Understand the approach IaC Spec Kit encourages AI assistants to follow
- Review and refine AI-generated specifications more effectively
- Provide better input by knowing what the AI is optimizing for

IaC Spec Kit's commands and templates are structured to help AI assistants generate specifications following these patterns. While AI assistants may not always follow them perfectly, IaC Spec Kit nudges them in the right direction. You focus on describing what you need—IaC Spec Kit helps the AI structure it appropriately.
...
IaC Spec Kit encourages a balanced approach. The toolkit's commands and templates guide AI assistants to include certain types of information while avoiding others:

### ✅ Encouraged to Include (High-Level Technical Decisions)

The toolkit guides AI assistants to include architectural patterns and service categories that significantly impact your requirements:
...
### ❌ Encouraged to Avoid (Cloud-Specific Implementation)

The toolkit guides AI assistants to avoid cloud provider-specific services or implementation details in specifications:
...
**Why avoid these?** They belong in the implementation plan (generated by `/iac.plan`), where the AI researches the specific cloud provider and makes informed technical decisions based on available services, pricing, and features.

## Examples of Specification Patterns

These examples show the patterns that IaC Spec Kit encourages AI assistants to follow. You don't need to write specs this way yourself—just describe your needs, and the toolkit helps the AI structure them appropriately.
...
## Common Patterns IaC Spec Kit Encourages

IaC Spec Kit's commands and templates encourage AI assistants to follow these patterns. Understanding them helps you provide better input and review the output effectively.

### Pattern 1: Service Category + Characteristics

IaC Spec Kit encourages describing service categories and characteristics rather than naming specific services:
...
IaC Spec Kit encourages focusing on capabilities and performance rather than specific configurations:
...
IaC Spec Kit encourages emphasizing desired outcomes rather than implementation details:
...
## When Technical Specifics Are Appropriate

Sometimes you have legitimate technical requirements that should be included in specifications. IaC Spec Kit helps AI assistants recognize these situations:
...
IaC Spec Kit encourages AI assistants to generate success criteria that are measurable and technology-agnostic. Here's what to expect:
...
## Quick Reference for Specification Patterns

Use this reference to understand the patterns IaC Spec Kit encourages:
...
## Working with IaC Spec Kit

When using IaC Spec Kit commands:

- **Describe your needs naturally**: IaC Spec Kit helps AI assistants structure them into proper specifications
- **Don't worry about perfect terminology**: IaC Spec Kit guides AI assistants to translate your intent into appropriate technical terms
- **Review and refine**: Check the generated spec and ask for adjustments if needed
- **Trust the process**: IaC Spec Kit's commands and templates guide AI assistants toward these patterns, though results may vary

## Need Help?

- See [examples/](../examples/) for complete specification examples showing these patterns in practice
- Review the [WordPress example](../examples/03-wordpress/) showing cloud-agnostic specs deployed to 4 clouds
- Check the [spec template](../templates/spec-template.md) to see the structure IaC Spec Kit encourages
- Use `/iac.specify` and let IaC Spec Kit guide the AI through the formatting
