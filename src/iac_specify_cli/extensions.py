"""
Extension Manager for IaC Spec Kit
...
Portted from upstream: https://github.com/github/spec-kit
Adapted for IaC Spec Kit (ibm/iac-spec-kit) with iac-specify CLI branding.
"""
        ...
        try:
            ...
            if current not in specifier:
                raise CompatibilityError(
                    ...
                    f"Upgrade spec-kit with: uv tool install iac-specify-cli --force"
                )
    ...
    def install_from_directory(
        ...
        if self.registry.is_installed(manifest.id):
            raise ExtensionError(
                ...
                f"Use 'iac-specify extension remove {manifest.id}' first."
            )
        ...
        for ext_id, metadata in self.registry.list().items():
            ...
            try:
                ...
                result.append({
                    ...
                    "description": "Corrupted extension",
                    "enabled": False,
                    "installed_at": metadata.get("installed_at"),
                    "command_count": 0,
                    "hook_count": 0
