...
**What this does**: The AI researches GCP best practices, well-architected framework principles, and terraform-google-modules. It then designs the complete infrastructure architecture.
...
| `/iac.plan` | `plan.md` (minimal) or `plan.md` + enriched docs | GCP-specific architecture |
