...
```
/iac.principles I'm building an enterprise cloud landing zone on GCP for a regulated industry. Security and compliance are critical. Multiple environments need isolation. Use Terraform with terraform-google-modules.
```
